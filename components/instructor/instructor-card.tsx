...
export function InstructorCard({
  ...
  return (
    <Link href={href} className="block group">
      <div className="bg-white rounded-2xl p-4 border border-transparent hover:border-gray-200 hover:shadow-sm transition-all">
            ...
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  {is_verified && (
                    <CheckCircle size={14} className="text-green-500 fill-green-500 flex-shrink-0" />
                  )}
                </div>
