  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        {/* Big 404 */}
        <div className="mb-6">
          <p className="text-8xl md:text-9xl font-bold text-[#FACC15] opacity-10 leading-none select-none">
            404
          </p>
          <div className="-mt-8">
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-sm border border-gray-100">
              <Search size={28} className="text-[#FACC15]" />
            </div>
          </div>
        </div>
        ...
        {/* Search bar */}
        <Link href="/search">
          <div className="bg-white border-2 border-gray-200 rounded-2xl px-4 py-3.5 flex items-center gap-3 mb-4 hover:border-[#FACC15] transition-colors cursor-pointer">
        ...
        <div className="flex gap-3">
          ...
          <Link href="/search" className="flex-1">
            <button className="w-full flex items-center justify-center gap-2 bg-[#FACC15] text-gray-900 font-semibold py-3 rounded-xl hover:bg-yellow-400 transition-colors text-sm">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {['Footscray', 'Sunshine', 'Coburg', 'Preston', 'Werribee'].map(s => (
              <Link
                ...
                className="text-xs bg-white border border-gray-200 text-gray-600 px-3 py-1.5 rounded-full hover:border-[#FACC15] hover:text-[#FACC15] transition-colors"
              >
                {s}
              </Link>
            ))}
